...
import static org.mediamarktsaturn.order.order.util.SpringContext.getBean;

@Slf4j
public class OrderManagerMailbox implements MailboxType, ProducesMessageQueue<OrderManagerMailbox.OrderManagerMessageQueue> {
    public OrderManagerMailbox(ActorSystem.Settings settings, Config config) {
