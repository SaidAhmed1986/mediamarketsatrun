package org.mediamarktsaturn.order.actor;
...
import org.mediamarktsaturn.order.common.eventsource.command.CreateOrderCommand;
import org.mediamarktsaturn.order.common.eventsource.command.GetOrderPaymentInfoCommand;
import org.mediamarktsaturn.order.common.eventsource.command.GetOrderShippingInfoCommand;
import org.mediamarktsaturn.order.common.eventsource.command.RetrieveOrderCommand;
import org.mediamarktsaturn.order.common.eventsource.command.UpdateOrderStatusCommand;
...
public class OrderManagerActor extends AbstractLoggingActor {
    ...
    public SupervisorStrategy supervisorStrategy() {
        return new OneForOneStrategy(
                ...
                DeciderBuilder.match(ProcessingOrderException.class, e -> SupervisorStrategy.resume())
